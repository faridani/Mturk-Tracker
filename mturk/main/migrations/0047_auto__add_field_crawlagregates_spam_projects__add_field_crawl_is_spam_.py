...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CrawlAgregates.spam_projects'
        db.add_column('main_crawlagregates', 'spam_projects', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Crawl.is_spam_computed'
        db.add_column('main_crawl', 'is_spam_computed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CrawlAgregates.spam_projects'
        db.delete_column('main_crawlagregates', 'spam_projects')

        # Deleting field 'Crawl.is_spam_computed'
        db.delete_column('main_crawl', 'is_spam_computed')
    ...
    models = {
        'main.crawl': {
            ...
            'is_spam_computed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
        ...
        'main.hitgroupcontent': {
            ...
            'is_spam': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'db_index': 'True'}),
