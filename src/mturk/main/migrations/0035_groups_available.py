...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_crawl', 'groups_available', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'main.hitgroupcontent': {
            ...
            'group_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True', 'db_index': 'True'}),
