...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Crawl.has_diffs'
        db.add_column('main_crawl', 'has_diffs', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Crawl.has_diffs'
        db.delete_column('main_crawl', 'has_diffs')
