...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HitGroupContent.is_spam'
        db.add_column('main_hitgroupcontent', 'is_spam', self.gf('django.db.models.fields.NullBooleanField')(null=True, db_index=True), keep_default=False)
        db.add_column('hits_mv', 'is_spam', self.gf('django.db.models.fields.NullBooleanField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HitGroupContent.is_spam'
        db.delete_column('main_hitgroupcontent', 'is_spam')
        db.delete_column('hits_mv', 'is_spam')
