...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crawl.errors'
        db.alter_column('main_crawl', 'errors', self.gf('mturk.fields.JSONField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Crawl.errors'
        db.alter_column('main_crawl', 'errors', self.gf('JSONField')('Errors', null=True))
