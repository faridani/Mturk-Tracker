...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DayStats.processed_value'
        db.add_column('main_daystats', 'processed_value', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DayStats.processed_value'
        db.delete_column('main_daystats', 'processed_value')
