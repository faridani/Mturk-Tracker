...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HitGroupContent.first_crawl'
        db.add_column('main_hitgroupcontent', 'first_crawl', orm['main.hitgroupcontent:first_crawl'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'HitGroupContent.first_crawl'
        db.delete_column('main_hitgroupcontent', 'first_crawl_id')
