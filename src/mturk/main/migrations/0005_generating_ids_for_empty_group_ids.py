...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HitGroupContent.group_id_hashed'
        db.add_column('main_hitgroupcontent', 'group_id_hashed', orm['main.hitgroupcontent:group_id_hashed'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'HitGroupContent.group_id_hashed'
        db.delete_column('main_hitgroupcontent', 'group_id_hashed')
