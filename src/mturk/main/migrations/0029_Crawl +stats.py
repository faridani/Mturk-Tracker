...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_crawl', 'hits_available', orm['main.crawl:hits_available'])
        
        # Adding field 'Crawl.hits_downloaded'
        db.add_column('main_crawl', 'hits_downloaded', orm['main.crawl:hits_downloaded'])
        
        # Adding field 'Crawl.groups_available'
        db.add_column('main_crawl', 'groups_available', orm['main.crawl:groups_available'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_crawl', 'hits_available')
        
        # Deleting field 'Crawl.hits_downloaded'
        db.delete_column('main_crawl', 'hits_downloaded')
        
        # Deleting field 'Crawl.groups_available'
        db.delete_column('main_crawl', 'groups_available')
    ...
    models = {
        ...
        'main.crawl': {
            ...
            'groups_available': ('django.db.models.fields.IntegerField', [], {}),
            'groups_downloaded': ('django.db.models.fields.IntegerField', [], {}),
            'hits_available': ('django.db.models.fields.IntegerField', [], {}),
            'hits_downloaded': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
