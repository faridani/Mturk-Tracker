...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Crawl.has_hits_mv'
        db.add_column('main_crawl', 'has_hits_mv', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Crawl.has_hits_mv'
        db.delete_column('main_crawl', 'has_hits_mv')
    ...
    models = {
        'main.crawl': {
            ...
            'has_hits_mv': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
